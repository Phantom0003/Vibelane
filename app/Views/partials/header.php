...
<body>
    ...
    <nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Vibelane navigation bar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsVibelane">
                ...
                <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                    <li><a class="nav-link" href="#"><img src="../public/image/user.svg"></a></li>
                    <li><a class="nav-link" href="cart.html"><img src="../public/image/cart.svg"></a></li>
                </ul>
            </div>
        </div>
    </nav>
